...
A React-based Tic Tac Toe game featuring different AI opponents, including a Deep Q-Network (DQN)
player and a Menace Matchboxes Engine.

## Features

- Play against a DQN AI powered
  by [mvrahden's reinforce-js](https://github.com/mvrahden/reinforce-js).
- Challenge the Menace Matchboxes Engine, inspired
  by [andrewmccarthy's Python version](https://github.com/andrewmccarthy/menace).
...
tool wouldn't be useful if you could not customize it when you are ready for it.
